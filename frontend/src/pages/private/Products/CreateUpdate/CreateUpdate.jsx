    ...
    if (isUpdate) {
      dispatch(updateProduct({ ...data,
        price: {
          ...
          discounted_until: productSelected.discounted_until,
          discounted_from: productSelected.discounted_from,
          price_discounted: productSelected.price_discounted,
        },
        images, imagesToDelete, setImages, setImagesToDelete, onClose, reset }));
    } else {
      dispatch(createProduct({ ...data, images, imagesToDelete, setImages, setImagesToDelete, onClose, reset }));
    }
  };
